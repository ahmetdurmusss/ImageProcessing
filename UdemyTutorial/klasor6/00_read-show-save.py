...
img = cv2.imread(r"materyal\\klasor6\\klon.jpg") # Okunacak Resmin Dosya Yolu 

imgGri= cv2.imread(r"materyal\\klasor6\\klon.jpg", 0) # Okunacak Resmin Dosya Yolu ve Resmin Gri Tonlama İle Okunması
cv2.imwrite(r"materyal\\klasor6\\klonGriVideo4.jpg", imgGri)
...
cv2.imwrite(r"materyal\\klasor6\\klonVideo4.jpg", img) # Resmi Kaydetme, İlk Parametre Kaydedilecek Resmin Adı, İkinci Parametre Resmin İçeriği
